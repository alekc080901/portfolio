...
**Освоенные языки программирования**: Python, Java, C, JavaScript;\
...
**Тема [дипломной работы](https://github.com/alekc080901/portfolio/blob/main/ВКР.pdf)**: *"Разработка программного модуля для формирования и классификации типовых замечаний на выпускаемую продукцию"*;\
...
## Опыт работы
В период с марта 2023 года по сентябрь 2023 года являлся младшим Python-разработчиком компании "Фабрика решений" в отделе компьютерного зрения.\
**Пример рабочего проекта**:\
*Веб-сайт для отложенной и регулярной постановки на сбор данных с видеокамер (Fullstack)*.
## Дисциплины и навыки
В данной таблице представлено описание дисциплин рабочей программы, связанных с программированием, и полученные в результате освоения дисциплин знания и навыки.\
На данный момент часть поздних дисциплин отсутствуют, проблема решится позднее.
...
| Введение в профессиональную  деятельность. Командный проект 	 | Python, MongoDB  	 | Основы REST, Python-фреймворк Flask, работа с данными в Python, работа с объектными базами данных (MongoDB), Docker                                                                                                                            	             |
...
| Тестирование программного обеспечения                         | Python 	           | Классы эквивалентности, Unit тестирование, End-to-End тестирование, тестирование веб-интерфейсов                                                                                       	                                                                     |
| Нейронные сети и их приложения                             	  | Jupyter Notebook 	 | Написание собственных многослойных персептронов, CNN, RNN; задачи классификации и детекции изображений; анализ тональности текстов                                                                                       	                                   |
| Разработка мобильных приложений                             	 | Flutter (Dart) 	   | Разработка интерфейсов мобильных приложений, работа с БД SQLite                                                                                      	                                                                                                       |
