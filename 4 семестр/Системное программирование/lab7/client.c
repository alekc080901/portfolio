...
int main(int argc, const char* argv[])
{
    ...
    char logPath[strlen(logDirectoryPath) + MAX_LOG_LENGTH + 1];
    strcpy(logPath, "./logs/clients.log");
    int time = 60;
    ...
    if (userPort != NULL && strchr(userPort, '/') != NULL)
    {
        printf("Incorrect log name: %s.\n", logPath);
        isWrong = true;
    }
