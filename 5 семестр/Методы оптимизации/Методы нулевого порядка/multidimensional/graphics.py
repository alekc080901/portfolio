from const import func, f_arguments, exact_extremum
...
if __name__ == '__main__':
    # assess(rosenbrock_algorithm, 'alpha', 1.1, 5, 0.1, x0=(0, 0))
    # assess(rosenbrock_algorithm, 'beta', -0.99, -0.01, 0.05, x0=(0, 0))
    assess(powell_method_n, 'epsilon', 0.01, 2, 0.02, interval=[-20, 20], x0=(-5, 5))
